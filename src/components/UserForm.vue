  ...
  <div class="form text-left">
    ...
    <div class="row">
      <div class="form-group col-md-6">
        ...
        <input type="text" v-model="player.GivenName" class="form-control">
      </div>
      <div class="form-group col-md-6">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" v-model="player.UserName" class="form-control">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" v-model="player.Persona" class="form-control">
      </div>
